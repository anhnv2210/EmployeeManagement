...
const ThemCapPhatTaiSanComponent = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await addCapPhatTaiSan(capPhatTaiSan);
            navigate('/cap-phat');
        } catch (error) {
            console.error("Error adding CapPhat:", error.response ? error.response.data : error.message);
            setError('Có lỗi xảy ra khi thêm cấp phát tài sản.');
        }
    };
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="mb-4">
                        ...
                        <input 
                            ...
                            name="ngayCapPhat"
                            value={capPhatTaiSan.ngayCapPhat} 
                            onChange={handleChange} 
                            required 
                        />
                    </div>
                    <div className="mb-4">
                        ...
                        <input 
                            ...
                            className="form-control border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                            name="ngayTraLai"
                            value={capPhatTaiSan.ngayTraLai} 
                            onChange={handleChange} 
                            required 
                        />
                    </div>
...
export default ThemCapPhatTaiSanComponent